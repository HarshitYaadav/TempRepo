"""
RNN Model for Water Stress Index Forecasting
"""
import torch
...
class BaseForecaster(nn.Module):
    """Base class for RNN/LSTM/GRU forecasters"""
...
class RNNForecaster(BaseForecaster):
    ...
    def __init__(self, input_size, hidden_size=64, num_layers=2, dropout=0.2, output_size=1):
        super().__init__(input_size, hidden_size, num_layers, dropout, output_size)
        self.rnn = nn.RNN(
...
class RNNTrainer:
    ...
    def __init__(
        ...
        Args:
            model: RNNForecaster model instance
